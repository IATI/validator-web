...
<template>
  ...
  <p>
    Search for an organisation and access the validation results of their public IATI data. New organisations and IATI
    files will be visible within 24 hours.
  </p>
